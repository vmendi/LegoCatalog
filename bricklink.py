...
# Download all XMLs from Bricklink's web page and then use this method to convert then to JSON
...
# Download all inventories from each set and insert it in SQL
