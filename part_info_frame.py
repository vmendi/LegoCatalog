...
class PartInfoFrame(Frame):
    def __init__(self, master):
        ...
        self.part_qty.grid(row=2, column=0, sticky='w')
        self.part_qty = Label(self, text='')
        self.part_qty.grid(row=2, column=1, sticky='w')

        self.part_size = Label(self, text='Part size:')
        self.part_size.grid(row=3, column=0, sticky='w')
        self.part_size = Label(self, text='')
        self.part_size.grid(row=3, column=1, sticky='w')

        self.category_name = Label(self, text='Category name:')
        self.category_name.grid(row=4, column=0, sticky='w')
        self.category_name = Label(self, text='')
        self.category_name.grid(row=4, column=1, sticky='w')

        self.category_id = Label(self, text='Category id:')
        self.category_id.grid(row=5, column=0, sticky='w')
        self.category_id = Label(self, text='')
        self.category_id.grid(row=5, column=1, sticky='w')
